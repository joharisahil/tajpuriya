...
export function WhyIndustriesWorkWithUsSection() {
  return (
    <section className="section-gap bg-brand-navy text-white">
      <Container>
        <div className="grid gap-10 lg:grid-cols-12">
          <div className="lg:col-span-4">
            <p className="text-label text-white/70">Why Industries Work With Us</p>
            <h2 className="mt-4 text-h1 text-white text-balance">Trust built through manufacturing discipline and dependable supply</h2>
          </div>
