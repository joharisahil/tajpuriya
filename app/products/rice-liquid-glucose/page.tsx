...
const product = getProductBySlug("rice-liquid-glucose");
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/products/rice-liquid-glucose"
  },
  openGraph: {
    title: product.seoTitle,
    description: product.seoDescription,
    url: `${siteConfig.url}/products/rice-liquid-glucose`,
...
export default function RiceLiquidGlucosePage() {
