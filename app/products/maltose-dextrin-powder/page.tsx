...
const product = getProductBySlug("maltose-dextrin-powder");

export const metadata: Metadata = {
  title: product.seoTitle,
  description: product.seoDescription,
  keywords: product.keywords,
  alternates: { canonical: "/products/maltose-dextrin-powder" },
  openGraph: {
    title: product.seoTitle,
    description: product.seoDescription,
    url: `${siteConfig.url}/products/maltose-dextrin-powder`,
...
export default function MaltoseDextrinPowderPage() {
